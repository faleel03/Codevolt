  ...
  return (
    <footer className="bg-white dark:bg-gray-800 shadow-sm border-t border-gray-200 dark:border-gray-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-4 md:flex md:items-center md:justify-between">
          <div className="text-center md:text-left">
            <p className="text-sm text-gray-500 dark:text-gray-400">
              &copy; {currentYear} EV Charge. All rights reserved.
            </p>
          </div>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 py-4 flex flex-col md:flex-row justify-center md:justify-between text-center md:text-left">
